...
class FaceBoundsOverlay @JvmOverloads constructor(
    ...
    /**
     * Repopulates the face bounds list, and calls for a redr4aw of the view.
     */
    ...
    private fun drawEmoji(canvas: Canvas, emotion: Emotion, centerX: Float, centerY: Float, width: Int) {
        val emojiDimen = width * 1.25f
        ...
        val xOffset = scaleX(emojiDimen / 2.0f, canvas)
        val yOffset = scaleY(emojiDimen / 2.0f, canvas)
